        ...
        <div class="pb-6 mb-4 border-b border-[#271F3C]">
          <Link href="/contact">
            <button class="w-full select-none flex bg-[#E2C16B] hover:bg-[#EED288] duration-150 hover:shadow-[0_0_16px_0] hover:shadow-[#EED288]/30 text-[#160e27] text-sm items-center space-x-2 relative px-3 justify-center py-1.5 rounded-md group">
              ...
              <div class="flex">
                <LucideArrowRight
                  class="w-5 h-5 stroke-2 opacity-0 -translate-x-4 group-hover:translate-x-2 group-hover:opacity-100 duration-150 relative"
                />
                <LucideMousePointerClick
                  class="w-5 h-5 stroke-2 -translate-x-4 group-hover:translate-x-4 group-hover:opacity-0 duration-150 relative"
                />
              </div>
            </button>
          </Link>
